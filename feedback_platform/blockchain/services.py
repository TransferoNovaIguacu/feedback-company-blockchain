...
# Inicializa o logger corretamente
logger = logging.getLogger(__name__)

class BlockchainService:
    def __init__(self):
        # 1) Conecta ao provider Ethereum
        self.w3 = Web3(Web3.HTTPProvider(settings.WEB3_PROVIDER_URL))
        # 2) Inicializa a conta a partir da PRIVATE_KEY
        self.account = self.w3.eth.account.from_key(settings.PRIVATE_KEY)
        self.admin_address = self.account.address
        
        # 3) Verifica se CONTRACT_ADDRESS existe e é um endereço válido
    ...
    def _load_contract(self):
        ...
        try:
            ...
            logger.error("❌ Arquivo FeedbackToken.json não encontrado em artifacts/.../FeedbackToken.json")
            self.contract = None
            return False
    ...
    def deploy_contract(self):
        ...
        try:
            ...
            # Ajusta a variável no settings para apontar ao novo contrato e recarrega
    ...
    def batch_mint(self, recipients, amounts):
        ...
        try:
            ...
            if base_fee is not None:
                ...
                logger.info(f"✅ batch_mint usando EIP-1559 | Base Fee: {base_fee} | Max Fee: {max_fee_per_gas}")
